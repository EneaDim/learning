...
# ----------------------------------------------
# Purpose: Xilinx Design Constraint for Cortex-M3
# ----------------------------------------------
## This file is modified from general .xdc for the Arty S7-50 Rev. E
...
# Internal generated clock from clock wizard - 40MHz
create_generated_clock -name sysclk  [get_pins {u_clk_wiz_0/clk_wiz_0/inst/mmcm_adv_inst/CLKOUT0} ]
...
# Support upto 40MHz SWD
#set swclk_period 25.0
create_clock -period $swclk_period -name SWCLK [get_ports {SWCLK}]
set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports { SWCLK }]; #IO_L18P_T2_A12_D28_14        Sch=jc1/ck_io[41]
...
# SWDIO
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { SWDIO }]; #IO_L18N_T2_A11_D27_14        Sch=jc2/ck_io[40]
...
set_input_delay  -clock [get_clocks SWCLK] -add_delay -max $sw_in_max_delay [get_ports {SWDIO}]
set_input_delay  -clock [get_clocks SWCLK] -add_delay -min $sw_in_th        [get_ports {SWDIO}]
set_output_delay -clock [get_clocks SWCLK] -add_delay -max $sw_out_tsu      [get_ports {SWDIO}]
set_output_delay -clock [get_clocks SWCLK] -add_delay -min $sw_out_th       [get_ports {SWDIO}]
...
#set_clock_groups -name async_group -asynchronous -group {sysclk} \
#                                                 -group {SWCLK} \
#                                                 -group {CLK100MHZ} \
#                                                 -group {slow_out_clk} \
#                                                 -group {CLK12MHZ}
...
# Internal timings
# --------------------------------------------------
# The DAP is asynchronous to the CPU, (SWCLK and sysclk).
# However need to ensure that all signals pass across the relevant CDC structures quickly enough
# This should be within 2 cycles of the fastest clock, (cpu_clk).  This is currently 40MHz, ~25ns.
# We only wish to constrain the actual datapath, we do not need to consider clock skew and jitter
# as these are asychronous clocks
set_max_delay -from [get_clocks sysclk] -to [get_clocks SWCLK]   -datapath_only 20.0
set_max_delay -from [get_clocks SWCLK]  -to [get_clocks sysclk]  -datapath_only 20.0
...
# Timing of switches doesn't matter
set_input_delay  -clock [get_clocks slow_out_clk] -add_delay $untimed_id [get_ports sw*]
...
# Timing of LEDs doesn't matter
set_output_delay -clock [get_clocks slow_out_clk] -add_delay $untimed_od [get_ports led*]
...
# Timing of buttons doesn't matter
set_input_delay  -clock [get_clocks slow_out_clk] -add_delay $untimed_id [get_ports btn*]
...
set_output_delay -clock [get_clocks sysclk] -add_delay $systimed_od [get_ports ja*]
set_input_delay  -clock [get_clocks sysclk] -add_delay $systimed_id [get_ports ja*]
...
set_output_delay -clock [get_clocks sysclk] -add_delay $systimed_od [get_ports jb*]
set_input_delay  -clock [get_clocks sysclk] -add_delay $systimed_id [get_ports jb*]
...
# UART
set_input_delay  -clock [get_clocks sysclk] -add_delay $systimed_id [get_ports uart_txd_in]
set_output_delay -clock [get_clocks sysclk] -add_delay $systimed_od [get_ports uart_rxd_out]
...
# Set as untimed
set_input_delay  -clock [get_clocks slow_out_clk] -add_delay $untimed_id [get_ports ck_rst]
